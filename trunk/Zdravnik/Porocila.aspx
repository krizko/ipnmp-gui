<%@ Page Language="C#" MasterPageFile="~/Master/DizajnWithSideBar.Master" AutoEventWireup="true" CodeBehind="Porocila.aspx.cs" Inherits="Dizajn.Porocila" Title="Untitled Page" %>
    ...
    <div>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            ...
            <tr>
                ...
                <td><%# DataBinder.Eval(Container.DataItem, "Avtor") %></td>
                <td><%# DataBinder.Eval(Container.DataItem, "StevilkaPorocila") %></td>
